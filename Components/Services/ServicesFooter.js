export default function ServicesFooter() {
  return (
    <footer className="bg-gray-900 text-white min-h-screen rounded-t-3xl">
        ...
        <div className="pb-16 overflow-hidden">
          ...
          <div className="text-white lg:rounded-l-3xl flex flex-col transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] flex-1 hover:flex-[2.2] group cursor-pointer relative overflow-hidden backdrop-blur-sm hover:shadow-2xl hover:shadow-purple-500/25 border-r border-white/10">
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
                <p className="text-white text-lg">Your browser doesn't support video playback</p>
              </div>
            </video>
            ...
            <div className="relative z-10 p-8 md:p-12 flex flex-col h-full">
              <div className="mb-8 transform group-hover:scale-105 transition-transform duration-700">
                <h3 className="text-4xl md:text-5xl font-bold mb-4 tracking-tight text-white drop-shadow-lg">Cases</h3>
                <p className="text-lg text-white/90 font-medium drop-shadow-md">Showtime</p>
              </div>
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-700 text-white p-8 md:p-12 flex flex-col transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] flex-1 hover:flex-[2.2] group cursor-pointer relative overflow-hidden hover:shadow-2xl hover:shadow-gray-500/25 border-x border-white/10">
            ...
            <div className="relative z-10">
              ...
              <div className="group-hover:hidden transform group-hover:scale-105 transition-transform duration-700">
                <h3 className="text-4xl md:text-5xl font-bold mb-4 tracking-tight">Services</h3>
                <p className="text-lg text-gray-300 font-medium">What to do</p>
              </div>

              {/* Hover state - expanded */}
              <div className="hidden group-hover:flex flex-col h-full animate-in fade-in duration-700">
                <div className="mb-8">
                  <h3 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight tracking-tight animate-in slide-in-from-left-8 duration-700">Services</h3>
                  <p className="text-xl text-gray-300 mb-4 font-medium animate-in slide-in-from-left-8 duration-700 delay-150">What to do</p>
                  <p className="text-lg text-gray-200 font-medium max-w-md animate-in slide-in-from-left-8 duration-700 delay-300">What we are extra good at.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-teal-600 to-emerald-700 text-white p-8 md:p-12 flex flex-col transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] flex-1 hover:flex-[2.2] group cursor-pointer relative overflow-hidden hover:shadow-2xl hover:shadow-teal-500/25 border-x border-white/10">
            ...
            <div className="relative z-10">
              {/* Normal state - compact */}
              <div className="group-hover:hidden transform group-hover:scale-105 transition-transform duration-700">
                <h3 className="text-4xl md:text-5xl font-bold mb-4 tracking-tight group-hover:text-white transition-colors duration-500">Learn</h3>
                <p className="text-lg text-teal-100 font-medium group-hover:text-teal-50 transition-colors duration-500">Our blog</p>
              </div>

              {/* Hover state - expanded */}
              <div className="hidden group-hover:flex flex-col h-full animate-in fade-in duration-700">
                <div className="mb-8">
                  <h3 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight tracking-tight animate-in slide-in-from-left-8 duration-700">Learn</h3>
                  <p className="text-xl text-teal-100 mb-4 font-medium animate-in slide-in-from-left-8 duration-700 delay-150">Our blog</p>
                  <p className="text-lg text-teal-50 font-medium max-w-md animate-in slide-in-from-left-8 duration-700 delay-300">Insights, tutorials, and industry trends.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-purple-600 to-pink-600 text-white lg:rounded-r-3xl p-8 md:p-12 flex flex-col transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] flex-1 hover:flex-[2.2] group cursor-pointer relative overflow-hidden hover:shadow-2xl hover:shadow-purple-500/25 border-l border-white/10">
            ...
            <div className="relative z-10">
              {/* Normal state - compact */}
              <div className="group-hover:hidden transform group-hover:scale-105 transition-transform duration-700">
                <h3 className="text-4xl md:text-5xl font-bold mb-4 tracking-tight group-hover:text-white transition-colors duration-500">Team</h3>
                <p className="text-lg text-purple-100 font-medium group-hover:text-purple-50 transition-colors duration-500">Who we are</p>
              </div>

              {/* Hover state - expanded */}
              <div className="hidden group-hover:flex flex-col h-full animate-in fade-in duration-700">
                <div className="mb-8">
                  <h3 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight tracking-tight animate-in slide-in-from-left-8 duration-700">Team</h3>
                  <p className="text-xl text-purple-100 mb-4 font-medium animate-in slide-in-from-left-8 duration-700 delay-150">Who we are</p>
                  <p className="text-lg text-purple-50 font-medium max-w-md animate-in slide-in-from-left-8 duration-700 delay-300">Meet the creative minds behind the magic.</p>
                </div>
              </div>
            </div>
          </div>
